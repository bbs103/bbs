...
<head>
	...
	<link rel="stylesheet" href="./Index/Public/css/admin.css" />
	<script type="text/javascript" src="./Admin/Apublic/js/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="./Admin/Apublic/js/admin.js"></script>
<!-- 默认打开目标 -->
<base target="iframe"/>
</head>
<body>
